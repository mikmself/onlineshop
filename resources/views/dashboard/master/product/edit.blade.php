        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="{{ route('updateproduct',$product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="desc" class="form-control"
                                                name="desc" placeholder="Desc" value="{{ $product->desc }}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
